...
document.querySelector(".Product2").addEventListener("click", function(){
    window.location.href = "Shoes2.html"
})
document.querySelector(".Product3").addEventListener("click", function(){
    window.location.href = "Shoes3.html"
})
document.querySelector(".Product4").addEventListener("click", function(){
    window.location.href = "Shoes4.html"
})

document.querySelector(".Product5").addEventListener("click", function(){
    window.location.href = "Shoes5.html"
})
document.querySelector(".Product6").addEventListener("click", function(){
    window.location.href = "Shoes6.html"
})
document.querySelector(".Product7").addEventListener("click", function(){
    window.location.href = "Shoes7.html"
})
document.querySelector(".Product8").addEventListener("click", function(){
    window.location.href = "Shoes8.html"
})
